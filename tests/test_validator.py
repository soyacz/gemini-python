...
def test_validator_passes_when_queried_rows_match():
    ...
    validator.validate(
        statement="insert",
        query_values=("test", "value"),
        expected_result=None,
    )

    validator.validate(statement="select", query_values=(), expected_result=["test", "value"])
...
def test_validator_fails_when_oracle_returns_value_and_is_expected_none():
    ...
    validator.validate(statement="select", query_values=(), expected_result=["test"])
...
def test_validator_passes_when_oracle_returns_none_and_is_expected_none():
    ...
    validator.validate(statement="select", query_values=(), expected_result=None)
